...
export const TEXT_MODELS: Record<TextModelId, TextModel> = {
  ...
  "openai-gpt-5-6-luna": {
    ...
    strengths: ["Schnell", tx({ de: "Günstig", en: "Affordable", es: "Asequible" }), "Varianten"],
  ...
  "google-gemini-3-1-flash-lite": {
    ...
    strengths: [tx({ de: "Sehr günstig", en: "Very affordable", es: "Muy asequible" }), "Schnell", "Zusammenfassen"],
