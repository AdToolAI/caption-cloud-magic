...
const T = {
  en: {
    ...
    dialog: { pass: 'Dialog locked', warn: 'Dialog draft', fail: 'Voiceover timing missing' },
  ...
  de: {
    ...
    hints: {
      ...
      shotFail: tx({ de: 'Wähle ein Shot-Director-Preset (Framing, Winkel, Bewegung, Licht).', en: 'Choose a shot director preset (framing, angle, movement, light).', es: 'Elija un ajuste preestablecido del director de toma (encuadre, ángulo, movimiento, luz).' }),
      shotWarn: tx({ de: 'Ergänze ein konkretes Linsen-/Bewegungs-Cue (z. B. "85mm langsamer Dolly-In").', en: 'Add a specific lens/movement cue (e.g. “85mm slow dolly-in”).', es: 'Agregue una señal de movimiento/lente específica (por ejemplo, “entrada rodante lenta de 85 mm”).' }),
      ...
      negativeFail: tx({ de: 'Setze einen Negative Prompt, um Text/Untertitel/Watermarks zu unterdrücken.', en: 'Set a Negative Prompt to suppress text/subtitles/watermarks.', es: 'Establezca un mensaje negativo para suprimir texto/subtítulos/marcas de agua.' }),
      negativeWarn: tx({ de: 'Negative ist kurz — ergänze z. B. "no captions, no subtitles".', en: 'Negative is short - add e.g. E.g. “no captions, no subtitles”.', es: 'Negativo es corto: agregue, p. P.ej. “sin leyendas, sin subtítulos”.' }),
      lengthFail: tx({ de: 'Prompt zu kurz (<35 Zeichen) — Provider liefern dann generische Aufnahmen.', en: 'Promptly too short (<35 characters) - providers then deliver generic recordings.', es: 'Rápidamente demasiado breve (<35 caracteres): los proveedores entregan grabaciones genéricas.' }),
      lengthFailLong: tx({ de: 'Prompt zu lang (>1200 Zeichen) — kürze auf "ein Outcome pro Zeile".', en: 'Promptly too long (>1200 characters) - shorten to "one outcome per line".', es: 'Inmediatamente demasiado largo (>1200 caracteres): acórtelo a "un resultado por línea".' }),
      lengthWarn: tx({ de: 'Prompt grenzwertig — Artlist empfiehlt 80–600 Zeichen pro Szene.', en: 'Prompt borderline — Artlist recommends 80-600 characters per scene.', es: 'Límite rápido: Artlist recomienda entre 80 y 600 caracteres por escena.' }),
