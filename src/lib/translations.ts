...
export const translations: Record<Language, any> = {
  en: {
    ...
    "pricing.subtitle": "Cancel monthly anytime. No hidden fees.",
    "pricing.free": "Free",
    "pricing.freePrice": "$0",
    ...
    "pricing.freeButton": "Start for free",
    "pricing.proMonthly": "Pro (Monthly)",
    "pricing.proYearly": "Pro (Yearly)",
    "pricing.month": "month",
    "pricing.year": "year",
    "pricing.cancelAnytime": "Cancel monthly anytime",
    ...
    "pricing.proButton": "Try Pro",
    "pricing.benefit1": "Cancel monthly anytime",
    "pricing.benefit2": "SSL-secure payment with Stripe",
  ...
  de: {
    ...
    "pricing.subtitle": "Monatlich kündbar. Keine versteckten Gebühren.",
    ...
    "pricing.freeButton": "Kostenlos starten",
    "pricing.proMonthly": "Pro (Monatlich)",
    "pricing.proYearly": "Pro (Jährlich)",
    "pricing.month": "Monat",
    "pricing.year": "Jahr",
    "pricing.cancelAnytime": "Monatlich kündbar",
    ...
    "pricing.proFeature5": "Auto-Reply & FAQ Builder",
    "pricing.proButton": "Pro testen",
    "pricing.benefit1": "Monatlich kündbar",
    "pricing.benefit2": "SSL-sichere Zahlung mit Stripe",
  ...
  es: {
    ...
    "pricing.subtitle": "Cancelación mensual en cualquier momento. Sin tarifas ocultas.",
    "pricing.free": "Gratis",
    "pricing.freePrice": "€0",
    ...
    "pricing.freeButton": "Comenzar gratis",
    "pricing.proMonthly": "Pro (Mensual)",
    "pricing.proYearly": "Pro (Anual)",
    "pricing.month": "mes",
    "pricing.year": "año",
    "pricing.cancelAnytime": "Cancelación mensual en cualquier momento",
    ...
    "pricing.proButton": "Probar Pro",
    "pricing.benefit1": "Cancelación mensual en cualquier momento",
    "pricing.benefit2": "Pago seguro SSL con Stripe",
