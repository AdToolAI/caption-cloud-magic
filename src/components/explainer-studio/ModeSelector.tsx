...
import { Sparkles, Hand, ArrowRight, Clock, Zap, Palette } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { cn } from '@/lib/utils';
import type { GenerationMode } from '@/types/explainer-studio';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          className={cn(
            ...
            "bg-gradient-to-br from-primary/10 via-purple-500/5 to-cyan-500/10",
        ...
        >
          ...
          <div className="absolute top-4 right-4">
            <div className="px-3 py-1 rounded-full bg-primary/20 border border-primary/40 text-xs font-medium text-primary">
              Empfohlen
            </div>
          </div>
          ...
          <div className="p-8">
            {/* Icon */}
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/30 to-purple-500/30 flex items-center justify-center mb-6">
            ...
            <p className="text-muted-foreground mb-6">
              Lehn dich zurück – die KI erstellt dein komplettes Video automatisch
            </p>
            ...
            <div className="space-y-3 mb-8">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span>Fertig in ~5-10 Minuten</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <Button 
              size="lg" 
              className={cn(
                "w-full bg-gradient-to-r from-primary via-primary to-purple-500",
          ...
          <div className="p-8">
            ...
            <div className="space-y-3 mb-8">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span>~20-30 Minuten Bearbeitung</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <div className="w-8 h-8 rounded-lg bg-muted/30 flex items-center justify-center">
