...
const TEXT = {
  ...
  de: {
    ...
    items: [
      ...
      { q: tx({ de: "Social-Posting fehlgeschlagen", en: "Social posting failed", es: "Error en la publicación en redes sociales" }), a: tx({ de: "Verbinde die Plattform unter Integrations neu. Meta/X brauchen oft Re-Auth nach Token-Ablauf.", en: "Reconnect the platform under Integrations. Meta/X often require re-auth after token expiration.", es: "Vuelve a conectar la plataforma en Integraciones. Meta/X a menudo requieren una nueva autenticación después de la expiración del token." }) },
      { q: tx({ de: "Ich finde mein exportiertes Video nicht", en: "I can't find my exported video", es: "No puedo encontrar mi video exportado" }), a: tx({ de: "Exporte landen in deiner Mediathek unter Videos. Frische Renders brauchen bis zu 1 Min., um zu erscheinen.", en: "Exports land in your media library under Videos. Fresh renders take up to 1 min to appear.", es: "Las exportaciones llegan a tu biblioteca de medios en Videos. Los renders nuevos tardan hasta 1 minuto en aparecer." }) },
