...
const TEXT = {
  ...
  de: {
    ...
    expectedPh: tx({ de: "z. B. Ein 60-Sek-Video im Composer mit Hailuo rendern.", en: "e.g. B. Render a 60 sec video in Composer with Hailuo.", es: "p.ej. B. Renderizar un vídeo de 60 segundos en Composer con Hailuo." }),
