...
const STRINGS = {
  en: {
    ...
    failed: tx({ de: "Upload failed", en: "Upload failed", es: "Error al subir" }),
  ...
  de: {
    ...
    badgeBold: tx({ de: "60% schneller gelöst", en: "solved 60% faster", es: "resuelto un 60% más rápido" }),
    recordScreen: tx({ de: "Bildschirm aufnehmen", en: "Record screen", es: "Grabar pantalla" }),
    stop: "Stopp",
    dropTitle: tx({ de: "Dateien hier ablegen", en: "Store files here", es: "Almacenar archivos aquí" }),
    ...
    dropMeta: (max: number, mb: number) => tx({ de: `Bilder, Videos (MP4/MOV/WebM), PDF · max ${max} Dateien · bis ${mb} MB`, en: `Images, videos (MP4/MOV/WebM), PDF · max ${max} files · up to ${mb} MB`, es: `Imágenes, vídeos (MP4/MOV/WebM), PDF · máximo ${max} archivos · hasta ${mb} MB` }),
    choose: tx({ de: "Dateien wählen", en: "Choose files", es: "Elegir archivos" }),
    max: tx({ de: "Maximum erreicht", en: "Maximum reached", es: "Máximo alcanzado" }),
    ...
    tooLarge: tx({ de: "Datei zu groß", en: "File too large", es: "Archivo demasiado grande" }),
    tooLargeDesc: (name: string, mb: number) => `${name} überschreitet ${mb} MB.`,
    unsupported: tx({ de: "Dateityp nicht unterstützt", en: "File type not supported", es: "Tipo de archivo no compatible" }),
    failed: tx({ de: "Upload fehlgeschlagen", en: "Upload failed", es: "Error al subir" }),
    recAdded: tx({ de: "Aufnahme angehängt", en: "Recording attached", es: "Grabación adjunta" }),
    quickTitle: tx({ de: "Schnell-Beweis", en: "Quick Evidence", es: "Prueba rápida" }),
