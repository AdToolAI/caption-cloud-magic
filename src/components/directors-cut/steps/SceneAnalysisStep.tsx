...
export function SceneAnalysisStep({
  ...
  const applyAllSuggestions = () => {
    ...
    const transitionInfo = skippedTransitions > 0 ? tx({ de: ` (${skippedTransitions} Transitions übersprungen)`, en: ` (${skippedTransitions} transitions skipped)`, es: ` (${skippedTransitions} transiciones omitidas)` }) : '';
  ...
  const applySingleSceneSuggestion = (scene: SceneAnalysis) => {
    ...
    const transitionInfo = skippedTransitions > 0 ? tx({ de: ` (${skippedTransitions} Transition übersprungen)`, en: ` (${skippedTransitions} transition skipped)`, es: ` (${skippedTransitions} transición omitida)` }) : '';
                      ...
                      <div className="mt-4 pt-4 border-t space-y-4" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="bg-muted/30 rounded-lg p-3">
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <span className="text-xs w-16 shrink-0">{tx({ de: "Sättigung", en: "Saturation", es: "Saturación" })}</span>
                              <Slider
                        ...
                        <div className="bg-muted/30 rounded-lg p-3">
                          ...
                          <div className="grid grid-cols-3 gap-4 mb-3">
                            ...
                            <div className="text-center">
                              <span className="text-xs text-muted-foreground block">{tx({ de: "Dauer", en: "Duration", es: "Duración" })}</span>
                          ...
                          <div className="bg-muted/30 rounded-lg p-3">
                            ...
                            {sceneTransitions[scene.id]?.type && (
                              <div className="flex items-center gap-4 mt-3 pt-3 border-t border-border/50">
                                <span className="text-xs font-medium">{tx({ de: "Dauer:", en: "Duration:", es: "Duración:" })}</span>
                                <Slider
