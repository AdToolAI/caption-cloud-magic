      ...
      {settings.enabled && (
        <div className="space-y-4">
          ...
          <div className="p-3 bg-muted/50 rounded-lg">
            <p className="text-xs text-muted-foreground">
              <strong>{tx({ de: "Hinweis:", en: "Note:", es: "Nota:" })}</strong> {tx({ de: "Für beste Slow-Motion Ergebnisse 240 FPS wählen.", en: "For best slow-motion results, choose 240 FPS.", es: "Para obtener los mejores resultados de cámara lenta, elige 240 FPS." })} 
