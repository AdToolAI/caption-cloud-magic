        ...
        <div className="flex-1 flex overflow-hidden min-w-0">
          ...
          >
            ...
            <div className="h-8 flex items-center gap-2 px-3 border-b border-[#F5C76A]/10 bg-[#050816]/60 min-w-0 flex-shrink-0 overflow-hidden">
              ...
              <span className="text-[11px] uppercase tracking-wider text-[#F5C76A]/70 font-semibold min-w-0 truncate">{tx({ de: 'Bibliothek', en: 'Library', es: 'Biblioteca' })}</span>
          ...
          <div className="flex-1 flex flex-col min-w-0">
            ...
            <div className="flex-1 border-t border-[#F5C76A]/10 overflow-hidden">
              <CapCutTimeline
                ...
                onSplitAtPlayhead={handleSplitAtPlayhead}
                onTrimScene={handleTrimScene}
                onSceneDuplicate={handleDuplicateScene}
