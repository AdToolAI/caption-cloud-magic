...
const copy = {
  de: {
    ...
    discountSub: tx({ de: "Automatisch im Checkout abgezogen", en: "Automatically deducted at checkout", es: "Deducido automáticamente al finalizar la compra" }),
    priority: tx({ de: "Priority-Rendering", en: "Priority rendering", es: "Renderizado prioritario" }),
    prioritySub: tx({ de: "Dein Slot geht bei Systemlast zuerst", en: "Your slot goes first when the system is busy", es: "Tu espacio va primero cuando el sistema está ocupado" }),
    studio: tx({ de: "Voller Studio-Zugang", en: "Full studio access", es: "Acceso completo al estudio" }),
    studioSub: tx({ de: "Autopilot, Cast & World, Director's Cut", en: "Autopilot, Cast & World, Director's Cut", es: "Piloto automático, Reparto y mundo, Montaje del director" }),
    remaining: (m: number) => `Noch ${m} ${m === 1 ? "Monat" : "Monate"} Vorteil`,
    remainingFallback: tx({ de: `${FOUNDERS_DISCOUNT_MONTHS} Monate Vorteil`, en: `${FOUNDERS_DISCOUNT_MONTHS} months of benefit`, es: `${FOUNDERS_DISCOUNT_MONTHS} meses de beneficio` }),
    ended: tx({ de: "Vorteilszeitraum beendet", en: "Benefit period ended", es: "Periodo de beneficio finalizado" }),
  },
  en: {
    eyebrow: "Founders Circle",
