...
export const FoundersSlotBadge = ({ className = "" }: Props) => {
  ...
  return (
    <div
      className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-primary/40 bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10 text-xs font-medium tracking-wide ${className}`}
    >
