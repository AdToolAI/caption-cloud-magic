                        ...
                        >
                          ...
                          <div className="flex flex-wrap gap-2 pt-3 mt-3 border-t border-white/5">
                            ...
                            >
                              ...
                              {isPreviewOpen ? tx({ de: tx({ de: "Vorschau schließen", en: "Close preview", es: "Cerrar vista previa" }), en: "Close preview", es: "Cerrar vista previa" }) : tx({ de: "Plattform-Vorschau", en: "Platform preview", es: "Vista previa de plataforma" })}
                            </Button>
                            <Button
                              size="sm"
                              variant="ghost"
