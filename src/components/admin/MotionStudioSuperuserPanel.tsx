...
const PIPELINE_STAGES = [
 { key: "Project", icon: Sparkles, scenarios: ["MS-1", "MS-2", "MS-25"] },
 { key: "Director", icon: Wand2, scenarios: ["MS-3", "MS-24"] },
 { key: "Assets", icon: Film, scenarios: ["MS-4", "MS-5", "MS-6", "MS-7", "MS-8", "MS-19", "MS-20", "MS-21", "MS-22", "MS-23"] },
 ...
 { key: "Export", icon: Download, scenarios: ["MS-15", "MS-16", "MS-17", "MS-26"] },
...
const ALL_SCENARIOS = [
 ...
 "MS-19: Voiceover Script Generation",
 "MS-20: ElevenLabs Voice List",
 "MS-21: Stock Music Search",
 "MS-22: Stock Video Search",
 "MS-23: Stock Image Search",
 "MS-24: FCPXML Re-Import (Round-Trip)",
 "MS-25: Trending Templates Schema",
 "MS-26: Composer Bundle Export Hardening",
];
