            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  {tx({ de: "{tx({ de: \"Geplante Posts · Optimale Zeiten · Konflikte — auf einen Blick\", en: \"Scheduled Posts · Optimal Times · Conflicts — at a glance\", es: \"Publicaciones programadas · Horas óptimas · Conflictos — de un vistazo\" })}", en: "Scheduled Posts · Optimal Times · Conflicts — at a glance", es: "Publicaciones programadas · Horas óptimas · Conflictos — de un vistazo" })}
                </p>
              </div>
            </div>
                            ...
                            <div className="space-y-1.5">
                              ...
                              {!hasPosts && !score && (
                                <div className="text-[10px] text-muted-foreground">
                                  {tx({ de: "{tx({ de: \"Klick: Post für diesen Slot erstellen\", en: \"Click: Create post for this slot\", es: \"Clic: Crear publicación para este espacio\" })}", en: "Click: Create post for this slot", es: "Clic: Crear publicación para este espacio" })}
                                </div>
                              )}
                              {!hasPosts && score && (
                                <div className="text-[10px] text-primary/80 italic">
                                  {tx({ de: "{tx({ de: \"Goldene Lücke — Klick zum Befüllen\", en: \"Golden Gap — Click to fill\", es: \"Brecha Dorada — Haz clic para rellenar\" })}", en: "Golden Gap — Click to fill", es: "Brecha Dorada — Haz clic para rellenar" })}
                                </div>
                              )}
                            </div>
                          </TooltipContent>
          ...
          {totalPosts === 0 && (
            ...
            >
              ...
              <p className="text-sm text-foreground/90 mb-1">
                {tx({ de: "{tx({ de: \"Noch keine Posts geplant — die cyan-Schimmer zeigen dir bereits, wann deine Audience aktiv ist.\", en: \"No posts scheduled yet — the cyan shimmer already shows you when your audience is active.\", es: \"Aún no hay publicaciones programadas — el brillo cian ya te muestra cuándo tu audiencia está activa.\" })}", en: "No posts scheduled yet — the cyan shimmer already shows you when your audience is active.", es: "Aún no hay publicaciones programadas — el brillo cian ya te muestra cuándo tu audiencia está activa." })}
              </p>
              <p className="text-xs text-muted-foreground mb-3">
                {tx({ de: "{tx({ de: \"Klick auf eine Zelle, um direkt einen Post für diesen Slot zu erstellen.\", en: \"Click on a cell to directly create a post for this slot.\", es: \"Haz clic en una celda para crear directamente una publicación para este espacio.\" })}", en: "Click on a cell to directly create a post for this slot.", es: "Haz clic en una celda para crear directamente una publicación para este espacio." })}
              </p>
              <Button
                size="sm"
