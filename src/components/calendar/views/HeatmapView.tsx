                            ...
                            <div className="space-y-1.5">
                              ...
                              {!hasPosts && !score && (
                                <div className="text-[10px] text-muted-foreground">
                                  {tx({ de: "Klick: Post für diesen Slot erstellen", en: "Click: Create post for this slot", es: "Clic: Crear publicación para esta franja" })}
                                </div>
                              )}
                              {!hasPosts && score && (
                                <div className="text-[10px] text-primary/80 italic">
                                  {tx({ de: "Goldene Lücke — Klick zum Befüllen", en: "Golden Gap — Click to fill", es: "Hueco de Oro — Clic para rellenar" })}
                                </div>
                              )}
                            </div>
                          </TooltipContent>
          ...
          {totalPosts === 0 && (
            ...
            >
              ...
              <p className="text-xs text-muted-foreground mb-3">
                {tx({ de: "Klick auf eine Zelle, um direkt einen Post für diesen Slot zu erstellen.", en: "Click on a cell to directly create a post for this slot.", es: "Haz clic en una celda para crear directamente una publicación para esta franja." })}
              </p>
              <Button
                size="sm"
