...
export function AppSidebar() {
  ...
  const hubStructure: Record<string, HubItem[]> = {
    ...
    optimieren: [
      ...
      { route: "/coach", titleKey: "nav.coach", icon: Bot },
      { route: "/bio-optimizer", titleKey: "nav.bioOptimizer", icon: User },
      { route: "/comment-manager", titleKey: "nav.commentManager", icon: MessageCircle },
    ],
    analysieren: [
      { route: "/performance", titleKey: "nav.analytics", icon: TrendingUp },
      { route: "/goals-dashboard", titleKey: "nav.goals", icon: Target },
      { route: "/trend-radar", titleKey: "nav.trendRadar", icon: Radar },
    ],
    automatisieren: [
      { route: "/campaigns", titleKey: "nav.campaigns", icon: Workflow },
    ],
    einstellungen: [
      { route: "/instagram-publishing", titleKey: "nav.integrations", icon: Share2 },
      { route: "/brand-kit", titleKey: "nav.brandKit", icon: Palette },
      { route: "/team-workspace", titleKey: "nav.team", icon: Users, plan: "pro" },
      { route: "/white-label", titleKey: "nav.whiteLabel", icon: Layers, plan: "enterprise" },
