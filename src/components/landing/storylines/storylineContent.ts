  ...
  video: [
    ...
    },
    {
      ...
      copy: S(
        ...
        [
          tx({ de: "Jeder Render zeigt vorher, wieviel Media-Credits er kostet. Kein Überraschungsverbrauch, keine versteckten Aufschläge — Beta-Preis 14,95 € eingerechnet.", en: "Every render shows beforehand how many media credits it costs. No surprise consumption, no hidden surcharges — Beta price $14.95 included.", es: "Cada render muestra de antemano cuántos créditos de medios cuesta. Sin consumo sorpresa, sin recargos ocultos — precio Beta de 14,95 € incluido." }),
          "Every render shows how many media credits it costs — up front. No surprise burn, no hidden markup — beta price 14.95 € included.",
          "Cada render muestra su coste en créditos — antes de lanzarlo. Sin sorpresas, sin recargos ocultos — precio beta 14,95 € incluido.",
        ],
      ),
    },
    {
  ...
  priceGuarantee: [
    ...
    },
    {
      ...
      copy: S(
        ...
        [
          tx({ de: "Das Abo kostet 14,95 € — für alle gleich. Als Founder bekommst du 24 Monate lang 20 % Rabatt auf jeden Kauf von KI-Credits.", en: "The subscription costs $14.95 — the same for everyone. As a Founder, you get a 20% discount on every AI credit purchase for 24 months.", es: "La suscripción cuesta 14,95 € — igual para todos. Como Founder, obtienes un 20% de descuento en cada compra de créditos de IA durante 24 meses." }),
          "The subscription is €14.95 for everyone. As a founder you get 20% off every AI credit purchase for 24 months.",
          "La suscripción cuesta 14,95 € para todos. Como founder obtienes un 20 % de descuento en cada compra de créditos IA durante 24 meses.",
        ],
      ),
    },
    {
