          ...
          <div className="mt-10 animate-fade-in">
            ...
            <div className="mt-6 text-center">
              ...
              <p className="mt-3 text-xs text-muted-foreground inline-flex items-center gap-1.5">
                ...
                {tx({ de: "14,95 €/Monat · Founder: 20 % auf alle KI-Credits für die ersten 1000 Nutzer", en: "$14.95/month · Founder: 20% off all AI credits for the first 1000 users", es: "14,95 €/mes · Fundador: 20% de descuento en todos los créditos de IA para los primeros 1000 usuarios" })}
              </p>
            </div>
          </div>
        )}
