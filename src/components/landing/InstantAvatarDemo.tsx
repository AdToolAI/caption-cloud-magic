        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <div className="rounded-2xl border border-primary/15 bg-card/40 backdrop-blur-xl p-5 flex flex-col">
            ...
            <div className="mt-3 flex items-start gap-2 text-[11px] text-muted-foreground">
              ...
              <p>
                {tx({ de: 'Foto nur zur Generierung, nach 24 h automatisch gelöscht.', en: 'Photo only for generation, deleted automatically after 24h.', es: 'Foto solo para generación, se elimina automáticamente después de 24 horas.' })} {tx({ de: "Keine\n                Weitergabe. 3 Versuche pro Stunde.", en: "No\n                sharing. 3 attempts per hour.", es: "No\n                compartir. 3 intentos por hora." })}
              </p>
            </div>
          </div>
        ...
        {hasResult && (
          <div className="mt-10 animate-fade-in">
            ...
            <div className="mt-6 text-center">
              ...
              >
                <Link to="/auth">
                  {tx({ de: "In Cast &amp; World speichern", en: "Save to Cast &amp; World", es: "Guardar en Cast &amp; World" })}
                  <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" />
                </Link>
              </Button>
              <p className="mt-3 text-xs text-muted-foreground inline-flex items-center gap-1.5">
                <ShieldCheck className="w-3.5 h-3.5 text-primary/70" />
                {tx({ de: "14,95 €/Monat · Founder: 10 % auf alle KI-Credits für die ersten 1000 Nutzer", en: "$14.95/month · Founder: 10% off all AI credits for the first 1000 users", es: "14,95 €/mes · Fundador: 10% de descuento en todos los créditos de IA para los primeros 1000 usuarios" })}
              </p>
            </div>
          </div>
        )}
