...
import { Check, FileText, Image, Play, Music, Download, Sparkles, Layout, MessageCircle, Loader2, Video, AlertTriangle, RefreshCw, ArrowLeft } from 'lucide-react';
...
export function UniversalVideoWizard() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      {/* Back Button - when in wizard */}
      {currentStep > 0 && currentStepId !== 'generating' && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="mb-4"
