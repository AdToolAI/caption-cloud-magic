        ...
        <div className="space-y-6 p-4 bg-muted rounded-lg">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Höhere Werte = {tx({ de: "Höhere Werte = konsistentere Stimme, niedrigere Werte = mehr Variation", en: "Higher values = more consistent voice, lower values = more variation", es: "Valores más altos = voz más consistente, valores más bajos = más variación" })}
            </p>
          </div>
