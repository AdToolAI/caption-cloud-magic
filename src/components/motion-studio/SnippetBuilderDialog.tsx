            ...
            <div className="flex-1">
              ...
              {!canPublish && (
                <p className="text-[10px] text-amber-500 mt-1">
                  Voraussetzung: Name ≥ {MIN_NAME} {tx({ de: "Zeichen, Prompt ≥", en: "Characters, Prompt ≥", es: "Caracteres, Prompt ≥" })} {MIN_PROMPT} {tx({ de: "Zeichen, Vorschaubild gesetzt.", en: "Characters, thumbnail set.", es: "Caracteres, miniatura establecida." })}
                </p>
              )}
            </div>
          </div>
