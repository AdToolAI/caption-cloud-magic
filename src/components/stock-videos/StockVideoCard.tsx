      ...
      >
        ...
        >
          ...
          <button
            ...
            title={isFavorite ? tx({ de: tx({ de: "Aus Favoriten entfernen", en: "Remove from favorites", es: "Quitar de favoritos" }), en: "Remove from Favorites", es: "Quitar de favoritos" }) : tx({ de: "Zu Favoriten hinzufügen", en: "Add to favorites", es: "Añadir a favoritos" })}
          >
