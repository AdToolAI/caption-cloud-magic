            ...
            <HoverCard openDelay={120}>
              ...
              <HoverCardContent side="top" className="w-[320px] text-[11px]">
                ...
                <div className="text-muted-foreground">
                  {tx({ de: "Dein Skript enthält", en: "Your script contains", es: "Tu script contiene" })} {scriptTiming!.mode === 'SHOT_MARKERS' ? 'explizite Shot-Marker' : tx({ de: "strukturierte Sprecher-Blöcke", en: "structured speaker blocks", es: "bloques de orador estructurados" })}.
            ...
            <HoverCard openDelay={80}>
              ...
              <HoverCardContent side="top" className="w-[380px] text-[11px] font-mono">
                ...
                <div className="mt-2 pt-2 border-t border-border/40 text-[10px] font-sans text-muted-foreground">
                  {tx({ de: "Nur sichtbar mit", en: "Only visible with", es: "Solo visible con" })} <code>?debug=1</code>.
                </div>
              </HoverCardContent>
            </HoverCard>
          )}
