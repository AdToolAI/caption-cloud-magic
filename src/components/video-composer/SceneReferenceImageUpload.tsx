      ...
      <div className="space-y-1.5">
        ...
        <div className="flex items-start gap-2">
          ...
          <p className="text-[10px] text-muted-foreground leading-snug pt-0.5">
            {tx({ de: "Die KI orientiert sich am Bildinhalt und Stil dieses Bildes (Image-to-Video).", en: "The AI is guided by the image content and style of this image (Image-to-Video).", es: "La IA se guía por el contenido y el estilo de esta imagen (Imagen a Video)." })}
          </p>
        </div>
      </div>
    );
