...
const FALLBACKS: Record<string, string> = {
  ...
  encodingUploading: tx({ de: 'Video wird kodiert & hochgeladen …', en: 'Encoding & uploading video …', es: 'Codificando y subiendo video …' }),
  ...
  clipsNotReady: tx({ de: 'Clips nicht bereit', en: 'Clips not ready', es: 'Clips no listos' }),
