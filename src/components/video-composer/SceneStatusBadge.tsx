...
const STATUS_TEXT: Record<string, TriText> = {
  ...
  'scene.status.plate_rendering': { de: 'Clip wird generiert', en: 'Clip is generated', es: 'Se genera el clip' },
  'scene.status.plate_ready': { de: 'Clip fertig', en: 'Clip ready', es: 'Clip listo' },
  'scene.status.audio_prep': { de: 'Voiceover wird erzeugt', en: 'Voiceover is generated', es: 'Se genera voz en off' },
  ...
  'scene.status.failed': { de: 'Fehlgeschlagen', en: 'Failed', es: 'Failed' },
