...
const labels = {
  de: {
    ...
    pickFromLibrary: 'Aus Cast & World wählen',
    pickerTitle: 'Charakter aus Cast & World verknüpfen',
    pickerDesc:
      'Verknüpfe einen Charakter aus Cast & World. Sein Referenzbild wird automatisch als Anker-Frame (i2v) für Szenen mit diesem Charakter genutzt — das ist der einzige zuverlässige Hebel für echte Gesichts-Konsistenz.',
    pickerEmpty: 'Noch keine Charaktere in Cast & World.',
    pickerSectionTitle: 'Cast & World (mit Referenzbild)',
    openCastWorld: 'Cast & World öffnen',
    ...
    proTipBody:
      'Beschreibe markante Kleidung & Objekte ausführlich (Mantel, Krone, Waffe). Die KI wiederholt diese viel zuverlässiger als Gesichter — der Zuschauer erkennt die Person daran. Für echte Gesichts-Konsistenz verknüpfe einen Charakter aus Cast & World (Button oben rechts).',
