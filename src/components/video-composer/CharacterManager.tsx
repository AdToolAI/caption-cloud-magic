...
const labels = {
  de: {
    ...
    name: 'Name',
    namePlaceholder: tx({ de: 'z. B. Richard Löwenherz', en: 'e.g. Richard the Lionheart', es: 'p. ej. Ricardo Corazón de León' }),
    appearance: tx({ de: 'Aussehen (Englisch empfohlen)', en: 'Appearance (English recommended)', es: 'Apariencia (recomendado en inglés)' }),
    appearancePlaceholder:
      'tall man late 30s, long auburn red hair, full beard, weathered face, blue eyes',
    signature: tx({ de: 'Markante Kleidung & Objekte (Englisch empfohlen)', en: 'Distinctive clothing & objects (English recommended)', es: 'Ropa y objetos distintivos (recomendado en inglés)' }),
