      ...
      <DialogContent className="max-w-3xl">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            Bitte weise jedem Sprecher{tx({ de: "Bitte weise jedem Sprecher das passende Gesicht (Slot 1…", en: "Please assign the correct face to each speaker (Slot 1…", es: "Por favor, asigna la cara correcta a cada orador (Slot 1…" })}{faces.length}) zu.
          </DialogDescription>
        </DialogHeader>
