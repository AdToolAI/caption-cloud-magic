...
const T = {
  de: {
    ...
    prequel: 'Prequel',
    prequelHint: tx({ de: 'Was passierte davor?', en: 'What happened before?', es: '¿Qué pasó antes?' }),
    crossfade: 'Crossfade',
    ...
    // Cast
    castLabel: tx({ de: 'Hauptdarsteller (AI-Engine)', en: 'Lead actor (AI engine)', es: 'Actor principal (motor de IA)' }),
    castOff: tx({ de: 'Im Off', en: 'Off-screen', es: 'Fuera de cámara' }),
    ...
    // Bridge target
    targetScene: tx({ de: 'Ziel-Szene', en: 'Target scene', es: 'Escena de destino' }),
    ...
    // Direct
    quality: tx({ de: 'Qualität', en: 'Quality', es: 'Calidad' }),
    standard: tx({ de: 'Standard', en: 'Standard', es: 'Estándar' }),
    pro: tx({ de: 'Pro', en: 'Pro', es: 'Pro' }),
    duration: tx({ de: 'Dauer', en: 'Duration', es: 'Duración' }),
    seconds: tx({ de: 'Sek.', en: 'Sec.', es: 'Seg.' }),
    prompt: tx({ de: 'Regie-Anweisung', en: 'Director's note', es: 'Instrucción del director' }),
    promptPh: tx({ de: 'Action! In dieser Szene …', en: 'Action! In this scene...', es: '¡Acción! En esta escena...' }),
    cost: tx({ de: 'Drehbudget', en: 'Shoot budget', es: 'Presupuesto de rodaje' }),
    ...
    rolling: tx({ de: 'Kamera läuft …', en: 'Camera running …', es: 'Cámara en marcha …' }),
  },
  en: {
    title: 'Director Mode',
