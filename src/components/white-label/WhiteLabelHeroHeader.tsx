...
export const WhiteLabelHeroHeader = () => {
  ...
  const features = useMemo(() => [
    { icon: Palette, label: t('wl.featureCustomBranding'), color: 'from-pink-500 to-rose-500' },
    { icon: Globe, label: t('wl.featureCustomDomain'), color: 'from-cyan-500 to-blue-500' },
    { icon: Code, label: t('wl.featureCssEditor'), color: 'from-purple-500 to-violet-500' },
  ], [t]);
    ...
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-card/80 via-card/60 to-card/40 backdrop-blur-xl border border-white/10 p-8 mb-8">
      ...
      <div className="relative z-10">
        ...
        >
          ...
          />
          <span className="text-sm font-medium text-primary">{t('wl.heroBadge')}</span>
