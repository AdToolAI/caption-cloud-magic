        ...
        <div className="relative flex items-start justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-sm text-muted-foreground max-w-xl">
              {tx({ de: "KI analysiert Schnittfrequenz, Mood &amp; Länge deines Videos und komponiert", en: "AI analyzes your video's edit frequency, mood &amp; length and composes", es: "La IA analiza la frecuencia de edición, el estado de ánimo y la duración de tu video y compone" })}
