          ...
          return (
            ...
            >
              ...
              <div className="text-xs text-muted-foreground">
                {tx({ de: "bis", en: "to", es: "a" })} {info.maxDuration}s • {info.engine}
              </div>
            </motion.button>
          );
        })}
            ...
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  {tx({ de: "Nur Sprachen, die dieser Provider sauber singt.", en: "Only languages that this provider sings cleanly.", es: "Solo idiomas que este proveedor canta limpiamente." })}
                </p>
              </div>
        ...
        >
          {loading ? (
            ...
            <>
              ...
              {tx({ de: "Track generieren ·", en: "Generate track ·", es: "Generar pista ·" })} {currencySymbol}{tierInfo.eur.toFixed(2)}
            </>
          )}
        </Button>
      </Card>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-muted-foreground flex items-center gap-2">
                    ...
                    <Badge variant="outline" className="text-[10px] h-4 border-primary/40 text-primary">
                      {tx({ de: "In Bibliothek gespeichert", en: "Saved to Library", es: "Guardado en la biblioteca" })}
                    </Badge>
                  </div>
                </div>
                <div className="flex items-center gap-2">
