      ...
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-5">
        ...
        <Card className="p-2 border-primary/20 bg-primary/5 flex items-center gap-2 text-[11px] text-primary-foreground/80">
          ...
          <span className="text-muted-foreground">
            {tx({ de: "Alle Treffer aus Pexels · Pixabay · Jamendo · Freesound (royalty-free, kommerziell nutzbar).", en: "All matches from Pexels · Pixabay · Jamendo · Freesound (royalty-free, commercially usable).", es: "Todos los resultados de Pexels · Pixabay · Jamendo · Freesound (sin royalties, uso comercial)." })}
