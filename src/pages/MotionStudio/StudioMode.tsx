        ...
        <Card className="p-6 bg-gradient-to-br from-primary/15 via-card/60 to-accent/10 backdrop-blur border-primary/30 space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              {tx({ de: "(Sora, Kling, Hailuo …), generierst Clips parallel und exportierst.", en: "(Sora, Kling, Hailuo…), generate clips in parallel and export.", es: "(Sora, Kling, Hailuo…), generas clips en paralelo y exportas." })}
            </p>
          </div>
          <Button
            onClick={onLaunch}
