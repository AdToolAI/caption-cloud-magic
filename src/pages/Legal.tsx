...
const Legal = () => {
  ...
  const seoContent = {
    ...
    terms: {
      ...
      description: "{tx({ de: 'Allgemeine Nutzungsbedingungen für AdTool AI. Rechtssicher und transparent.",
      en: "General Terms of Service for AdTool AI. Legally sound and transparent.",
      es: "Términos y condiciones generales de AdTool AI. Legalmente sólidos y transparentes.' })}"
    },
    imprint: {
