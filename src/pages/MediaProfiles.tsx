...
export default function MediaProfiles() {
  ...
  const handleSetDefault = async (profileId: string, platform: string) => {
    ...
    toast({
      title: tx({ de: 'Standard gesetzt', en: 'Default set', es: 'Establecer predeterminado' }),
  ...
  const handleDelete = async (profileId: string) => {
    ...
    toast({
      title: tx({ de: 'Profil gelöscht', en: 'Profile deleted', es: 'Perfil eliminado' }),
  ...
  return (
    <>
      ...
      <div className="container max-w-6xl py-8">
        ...
        <div className="mb-6">
          <Label>{tx({ de: "Plattform filtern", en: "Filter platform", es: "Filtrar plataforma" })}</Label>
          ...
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <p className="text-muted-foreground mb-4">
                {filterPlatform === 'all' 
                  ? tx({ de: tx({ de: "Noch keine Profile vorhanden.", en: "No profiles yet.", es: "Todavía no hay perfiles." }), en: 'No profiles yet.', es: 'Aún no hay perfiles.' })
