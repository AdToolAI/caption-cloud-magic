                    ...
                    {active.subjects?.map((s, i) => (
                      <div key={i} className="p-3 rounded-md border border-border flex items-center justify-between gap-3">
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="text-xs text-muted-foreground">{s.angle} · {s.text.length} {tx({ de: "Zeichen", en: "Characters", es: "Caracteres" })}</div>
                        </div>
                      ...
                      <Card key={vi} className="p-4 border-primary/10">
                        ...
                        <div className="mt-3 pt-3 border-t border-border">
                          ...
                          <p className="text-[10px] text-muted-foreground mt-2">
                            {tx({ de: "Test wird an deine Account-Email ($", en: "Test will be sent to your account email ($", es: "La prueba se enviará a tu correo electrónico de cuenta ($" })}{user?.email}) gesendet.
                          </p>
                        </div>
                      </Card>
                    ))}
