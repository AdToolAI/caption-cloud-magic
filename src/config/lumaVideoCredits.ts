...
export const LUMA_VIDEO_MODELS = {
  'luma-standard': {
    ...
    description: {
      EUR: tx({ de: 'Cinematic AI-Videos ab 0,78 € pro 5 Sekunden', en: 'Cinematic AI videos from €0.78 per 5 seconds', es: 'Vídeos cinematográficos con IA desde 0,78 € por 5 segundos' }),
      USD: 'Cinematic AI videos from $0.78 per 5 seconds',
    },
  ...
  'luma-pro': {
    ...
    allowedDurations: [5, 9] as const,
    description: {
      EUR: tx({ de: 'Premium cinematic Qualität ab 1,27 € pro 5 Sekunden', en: 'Premium cinematic quality from €1.27 per 5 seconds', es: 'Calidad cinematográfica premium desde 1,27 € por 5 segundos' }),
      USD: 'Premium cinematic quality from $1.27 per 5 seconds',
    },
  ...
  'luma-ray32-5s': {
    ...
    description: {
      EUR: tx({ de: 'Ray 3.2 · neueste Luma-Generation — 0,68 € pro Clip', en: 'Ray 3.2 · latest Luma generation — €0.68 per clip', es: 'Ray 3.2 · última generación de Luma — 0,68 € por clip' }),
      USD: 'Ray 3.2 · latest Luma generation — $0.68 per clip',
    },
  ...
  'luma-ray32-10s': {
    ...
    description: {
      EUR: tx({ de: 'Ray 3.2 · 10s Langclip — 2,00 € pro Clip', en: 'Ray 3.2 · 10s long clip — €2.00 per clip', es: 'Ray 3.2 · clip largo de 10 segundos — 2,00 € por clip' }),
      USD: 'Ray 3.2 · 10s long clip — $2.00 per clip',
    },
    badge: tx({ de: 'Neu', en: 'New', es: 'Nuevo' }),
  },
} as const;
