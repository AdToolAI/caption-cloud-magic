...
export const CORPORATE_AD_INTERVIEW: CategoryInterviewConfig = {
  ...
  phases: [
    ...
    { id: 'ca-2', phase: 2, question: tx({ de: "Welches Produkt oder welche Dienstleistung möchtest du bewerben?", en: "Which product or service do you want to promote?", es: "¿Qué producto o servicio quieres promocionar?" }), purpose: 'Produktdefinition', inputType: 'text', required: true },
    { id: 'ca-3', phase: 3, question: tx({ de: "Beschreibe dein Unternehmen/Service in 2-3 Sätzen. Was macht es besonders?", en: "Describe your company/service in 2-3 sentences. What makes it special?", es: "Describe tu empresa/servicio en 2-3 frases. ¿Qué lo hace especial?" }), purpose: 'USP-Erfassung', inputType: 'text', required: true },
    { id: 'ca-4', phase: 4, question: tx({ de: 'Wer ist deine Zielgruppe? Beschreibe deinen idealen Kunden.', en: 'Who is your target audience? Describe your ideal customer.', es: '¿Quién es tu público objetivo? Describe a tu cliente ideal.' }), purpose: 'Zielgruppenanalyse', inputType: 'text', required: true, quickReplies: ['Junge Erwachsene 18-25', 'Berufstätige 25-45', tx({ de: "Familien mit Kindern", en: "Families with children", es: "Familias con niños" }), 'Best Ager 50+', 'B2B Entscheider'] },
    ...
    { id: 'ca-7', phase: 7, question: tx({ de: 'Was unterscheidet dich von der Konkurrenz? Nenne 2-3 Alleinstellungsmerkmale.', en: 'What sets you apart from the competition? Name 2-3 unique selling points.', es: '¿Qué te diferencia de la competencia? Nombra 2 o 3 puntos de venta únicos.' }), purpose: 'Differenzierung', inputType: 'text', required: true },
    ...
    { id: 'ca-9', phase: 9, question: tx({ de: "Welche Aktion soll der Zuschauer nach dem Video ausführen?", en: "What action should the viewer take after the video?", es: "¿Qué acción debe realizar el espectador después del vídeo?" }), purpose: 'CTA-Definition', inputType: 'select', options: ['Website besuchen', 'Jetzt kaufen', 'Kostenlos testen', 'Termin buchen', 'Mehr erfahren', 'Anrufen', 'App herunterladen'], required: true },
    ...
    { id: 'ca-11', phase: 11, question: tx({ de: "Wo soll das Video primär ausgespielt werden?", en: "Where should the video primarily be played?", es: "¿Dónde debería reproducirse principalmente el vídeo?" }), purpose: 'Plattformoptimierung', inputType: 'multiselect', options: ['TV/Streaming', 'YouTube', 'Facebook/Instagram', 'TikTok', 'LinkedIn', 'Website', 'Messe/Event'], required: true },
    { id: 'ca-12', phase: 12, question: tx({ de: 'Welche Videolänge bevorzugst du?', en: 'What video length do you prefer?', es: '¿Qué duración de vídeo prefieres?' }), purpose: 'Dauer', inputType: 'select', options: [tx({ de: "15 Sekunden (Bumper)", en: "15 seconds (bumper)", es: "15 segundos (parachoques)" }), tx({ de: "30 Sekunden (Standard)", en: "30 seconds (default)", es: "30 segundos (predeterminado)" }), tx({ de: "60 Sekunden (Ausführlich)", en: "60 seconds (Detailed)", es: "60 segundos (detallado)" }), tx({ de: "90 Sekunden (Storytelling)", en: "90 seconds (storytelling)", es: "90 segundos (narración)" })], required: true },
    { id: 'ca-13', phase: 13, question: tx({ de: 'Welchen visuellen Stil stellst du dir vor?', en: 'What visual style do you envision?', es: '¿Qué estilo visual imaginas?' }), purpose: 'Stil-Definition', inputType: 'select', options: ['Modern & Clean', 'Bold & Farbenfroh', 'Minimalistisch', 'Cinematic', 'Corporate/Seriös', 'Trendy/Social Media'], required: true },
    ...
    { id: 'ca-15', phase: 15, question: tx({ de: "Hast du ein Logo, das eingebunden werden soll?", en: "Do you have a logo that would like to be included?", es: "¿Tiene algún logotipo que le gustaría incluir?" }), purpose: 'Logo-Integration', inputType: 'select', options: ['Ja, ich lade es hoch', 'Nein, kein Logo nötig', tx({ de: "Logo wird später ergänzt", en: "Logo will be added later", es: "El logotipo se agregará más tarde." })], required: true },
    { id: 'ca-16', phase: 16, question: tx({ de: "Soll ein animierter Charakter/Maskottchen im Video erscheinen?", en: "Should an animated character/mascot appear in the video?", es: "¿Debería aparecer un personaje/mascota animada en el vídeo?" }), purpose: 'Charakter', inputType: 'select', options: [tx({ de: 'Ja, mit Charakter', en: 'Yes, with character', es: 'Sí, con carácter' }), 'Nein, nur Grafiken', 'Vielleicht, bin unsicher'], required: true },
    { id: 'ca-17', phase: 17, question: tx({ de: "Welche Stimme soll das Voice-Over haben?", en: "Which voice should the voice-over have?", es: "¿Qué voz debe tener la locución?" }), purpose: 'Voice-Over', inputType: 'select', options: ['Männlich, professionell', 'Männlich, freundlich', 'Weiblich, professionell', 'Weiblich, warm', 'Männlich, energetisch', 'Weiblich, dynamisch'], required: true },
    { id: 'ca-18', phase: 18, question: tx({ de: "In welcher Sprache soll das Video sein?", en: "What language should the video be in?", es: "¿En qué idioma debe estar el vídeo?" }), purpose: 'Sprache', inputType: 'select', options: ['Deutsch', 'Englisch', 'Deutsch & Englisch'], required: true },
    ...
    { id: 'ca-20', phase: 20, question: tx({ de: 'Gibt es besondere Szenen oder Momente, die unbedingt vorkommen sollen?', en: 'Are there any special scenes or moments that absolutely must be included?', es: '¿Hay alguna escena o momento especial que deba incluirse sí o sí?' }), purpose: tx({ de: "Szenen-Wünsche", en: "Scene requests", es: "Solicitudes de escena" }), inputType: 'text', required: false },
...
export const PRODUCT_AD_INTERVIEW: CategoryInterviewConfig = {
  ...
  phases: [
    ...
    { id: 'pa-8', phase: 8, question: tx({ de: 'Welchen FILMISCHEN STIL stellst du dir vor?', en: 'What FILM STYLE do you imagine?', es: '¿Qué ESTILO DE CINE te imaginas?' }), purpose: 'Filmischer Stil', inputType: 'select', options: ['Apple-like minimal & clean', 'Nike-energetisch & dynamisch', 'Luxury-elegant & premium', 'Lifestyle casual & authentisch', 'Tech-futuristisch & innovativ', 'Handmade/Organic & natürlich'], required: true },
    { id: 'pa-9', phase: 9, question: tx({ de: "Gibt es ein UNBOXING- oder REVEAL-MOMENT den wir dramatisch inszenieren können?", en: "Is there an UNBOXING or REVEAL MOMENT that we can stage dramatically?", es: "¿Existe un MOMENTO DE UNBOXING o REVEAL que podamos escenificar dramáticamente?" }), purpose: 'Reveal-Moment', inputType: 'text', required: false, quickReplies: ['Ja, Unboxing inszenieren', 'Ja, dramatischer Product-Reveal', tx({ de: 'Nein, direkt mit Produkt starten', en: 'No, start directly with the product', es: 'No, empezar directamente con el producto' })] },
    ...
    { id: 'pa-12', phase: 12, question: tx({ de: "Welche Aktion soll der Zuschauer nach dem Video ausführen?", en: "What action should the viewer take after the video?", es: "¿Qué acción debe realizar el espectador después del vídeo?" }), purpose: 'CTA', inputType: 'select', options: ['Jetzt kaufen', 'Mehr erfahren', 'Kostenlos testen', 'Zum Shop', 'Vorbestellen', 'Link in Bio'], required: true },
    ...
    { id: 'pa-15', phase: 15, question: tx({ de: "Soll ein animierter Charakter im Video erscheinen?", en: "Should an animated character appear in the video?", es: "¿Debería aparecer un personaje animado en el vídeo?" }), purpose: 'Charakter', inputType: 'select', options: [tx({ de: 'Ja, mit Charakter', en: 'Yes, with character', es: 'Sí, con carácter' }), 'Nein, Produkt im Fokus', 'Nur Hände/Interaktion'], required: true },
    { id: 'pa-16', phase: 16, question: tx({ de: "Welche Stimme soll das Voice-Over haben?", en: "Which voice should the voice-over have?", es: "¿Qué voz debe tener la locución?" }), purpose: 'Voice-Over', inputType: 'select', options: ['Männlich, professionell', 'Männlich, locker & modern', 'Weiblich, warm & vertrauensvoll', 'Weiblich, dynamisch & energetisch'], required: true },
    ...
    { id: 'pa-18', phase: 18, question: tx({ de: 'Welche Videolänge bevorzugst du?', en: 'What video length do you prefer?', es: '¿Qué duración de vídeo prefieres?' }), purpose: 'Dauer', inputType: 'select', options: [tx({ de: "15 Sekunden (Bumper)", en: "15 seconds (bumper)", es: "15 segundos (parachoques)" }), tx({ de: "30 Sekunden (Standard)", en: "30 seconds (default)", es: "30 segundos (predeterminado)" }), tx({ de: "60 Sekunden (Ausführlich)", en: "60 seconds (Detailed)", es: "60 segundos (detallado)" }), tx({ de: "90 Sekunden (Storytelling)", en: "90 seconds (storytelling)", es: "90 segundos (narración)" })], required: true },
    { id: 'pa-19', phase: 19, question: tx({ de: "Gibt es etwas, das du auf keinen Fall im Video haben möchtest?", en: "Is there anything you definitely don't want to have in the video?", es: "¿Hay algo que definitivamente no quieras que aparezca en el vídeo?" }), purpose: 'Ausschlüsse', inputType: 'text', required: false },
    { id: 'pa-20', phase: 20, question: 'Perfekt! Ich habe alles. Noch etwas ergänzen?', purpose: 'Finale', inputType: 'text', required: false, quickReplies: [tx({ de: "Nein, Video erstellen!", en: "No, create a video!", es: "¡No, crea un vídeo!" }), 'Ja, ich ergänze...'] }
  ],
  totalPhases: 20,
...
export const STORYTELLING_INTERVIEW: CategoryInterviewConfig = {
  ...
  categoryDescription: tx({ de: "Emotionale Geschichten — erfunden oder wahr, filmisch erzählt", en: "Emotional stories – fictional or true, told on film", es: "Historias emocionales, ficticias o reales, contadas en una película." }),
  icon: '📖',
  phases: [
    ...
    { id: 'story-2', phase: 2, question: tx({ de: 'Welche Art von Geschichte möchtest du erzählen?', en: 'What kind of story do you want to tell?', es: '¿Qué tipo de historia quieres contar?' }), purpose: 'Story-Typ', inputType: 'select', options: ['Gründergeschichte', 'Markengeschichte', 'Kundengeschichte', 'Fiktive Story', 'Unternehmensgeschichte', 'Vision & Mission'], required: true },
    ...
    { id: 'story-4', phase: 4, question: tx({ de: "Was ist der Ausgangspunkt der Geschichte? Wie war die Situation am Anfang?", en: "What is the starting point of the story? What was the situation at the beginning?", es: "¿Cuál es el punto de partida de la historia? ¿Cuál era la situación al principio?" }), purpose: 'Setup', inputType: 'text', required: true },
    ...
    { id: 'story-9', phase: 9, question: 'Welche Emotion soll der Zuschauer am Ende empfinden?', purpose: tx({ de: 'Emotionales Ziel', en: 'Emotional goal', es: 'Meta emocional' }), inputType: 'select', options: ['Inspiriert', 'Berührt', 'Motiviert', 'Vertrauensvoll', 'Begeistert', 'Hoffnungsvoll', 'Verbunden'], required: true },
    ...
    { id: 'story-11', phase: 11, question: tx({ de: "Was ist die zentrale Botschaft, die hängen bleiben soll?", en: "What is the central message that should stick?", es: "¿Cuál es el mensaje central que debería mantenerse?" }), purpose: 'Kernbotschaft', inputType: 'text', required: true },
    ...
    { id: 'story-13', phase: 13, question: 'Wie lang soll die Geschichte sein?', purpose: 'Dauer', inputType: 'select', options: [tx({ de: "60 Sekunden (Kurzform)", en: "60 seconds (short form)", es: "60 segundos (forma corta)" }), tx({ de: "90 Sekunden (Standard)", en: "90 seconds (default)", es: "90 segundos (predeterminado)" }), '2 Minuten (Ausführlich)', '3 Minuten (Episch)'], required: true },
    { id: 'story-14', phase: 14, question: tx({ de: 'Welchen visuellen Stil stellst du dir vor?', en: 'What visual style do you envision?', es: '¿Qué estilo visual imaginas?' }), purpose: 'Visueller Stil', inputType: 'select', options: ['Cinematic & Filmisch', 'Dokumentarisch & Authentisch', 'Emotional & Warm', 'Modern & Stylisch', 'Nostalgisch & Vintage', 'Künstlerisch & Kreativ'], required: true },
    ...
    { id: 'story-16', phase: 16, question: tx({ de: 'Soll ein Charakter oder eine Person im Video erscheinen?', en: 'Should a character or person appear in the video?', es: '¿Debería aparecer un personaje o una persona en el video?' }), purpose: 'Charakter', inputType: 'select', options: ['Ja, animierter Charakter', 'Ja, reale Person (als Animation)', tx({ de: "Nein, nur visuelle Szenen", en: "No, just visual scenes", es: "No, solo escenas visuales." }), tx({ de: "Symbol oder Maskottchen", en: "Symbol or mascot", es: "Símbolo o mascota" })], required: true },
    ...
    { id: 'story-22', phase: 22, question: tx({ de: "Hast du Referenzvideos, die dich inspiriert haben?", en: "Do you have any reference videos that inspired you?", es: "¿Tienes algún vídeo de referencia que te haya inspirado?" }), purpose: 'Referenzen', inputType: 'text', required: false },
...
export const CUSTOM_INTERVIEW: CategoryInterviewConfig = {
  ...
  categoryDescription: tx({ de: "Volle Kontrolle — erstelle jedes beliebige Video", en: "Full control — create any video you want", es: "Control total: crea cualquier vídeo que quieras" }),
  icon: '✨',
  phases: [
    { id: 'cust-1', phase: 1, question: tx({ de: "Willkommen im Freien Editor! Beschreibe deine Video-Idee in 2-3 Sätzen.", en: "Welcome to Free Editor! Describe your video idea in 2-3 sentences.", es: "¡Bienvenido a Editor gratuito! Describe tu idea de video en 2 o 3 oraciones." }), purpose: 'Idee', inputType: 'text', required: true },
    { id: 'cust-2', phase: 2, question: tx({ de: 'Was für eine Art Video möchtest du erstellen?', en: 'What kind of video do you want to create?', es: '¿Qué tipo de video quieres crear?' }), purpose: tx({ de: "Video-Typ", en: "Video guy", es: "chico de vídeo" }), inputType: 'select', options: ['Tutorial/How-To', 'Erklärvideo', 'Social Media Content', tx({ de: "Event-Video", en: "Event video", es: "Vídeo del evento" }), 'Promo/Teaser', 'Präsentation/Pitch', 'Testimonial', 'Anderes'], required: true },
    { id: 'cust-3', phase: 3, question: tx({ de: "Welches Ziel soll das Video erreichen?", en: "What goal should the video achieve?", es: "¿Qué objetivo debe alcanzar el vídeo?" }), purpose: 'Ziel', inputType: 'text', required: true },
    ...
    { id: 'cust-5', phase: 5, question: tx({ de: "Gibt es ein Produkt, Service oder Thema im Fokus? Beschreibe es.", en: "Is there a product, service or topic in focus? Describe it.", es: "¿Hay algún producto, servicio o tema en foco? Descríbelo." }), purpose: 'Fokus', inputType: 'text', required: true },
    ...
    { id: 'cust-7', phase: 7, question: tx({ de: "Welche Struktur soll das Video haben?", en: "What structure should the video have?", es: "¿Qué estructura debe tener el vídeo?" }), purpose: 'Struktur', inputType: 'select', options: ['Problem → Lösung', 'Hook → Wert → CTA', tx({ de: "Schritt-für-Schritt", en: "Step by step", es: "Paso a paso" }), 'Vorher/Nachher', 'Feature-Showcase', 'Freie Erzählung', 'Listenformat'], required: true },
    { id: 'cust-8', phase: 8, question: tx({ de: 'Welchen visuellen Stil stellst du dir vor?', en: 'What visual style do you envision?', es: '¿Qué estilo visual imaginas?' }), purpose: 'Visueller Stil', inputType: 'select', options: ['Modern & Clean', 'Cinematic', 'Minimalistisch', 'Bold & Farbenfroh', 'Comic/Cartoon', 'Dokumentarisch', 'Futuristisch'], required: true },
    { id: 'cust-9', phase: 9, question: tx({ de: "Welche Farben sollen verwendet werden?", en: "Which colors should be used?", es: "¿Qué colores se deben utilizar?" }), purpose: 'Farben', inputType: 'text', required: true, quickReplies: ['Blau & Weiß', 'Schwarz & Gold', 'Bunt & Lebendig', 'Markenfarben'] },
    { id: 'cust-10', phase: 10, question: tx({ de: "Wie lang soll das Video sein?", en: "How long should the video be?", es: "¿Cuánto tiempo debe durar el vídeo?" }), purpose: 'Dauer', inputType: 'select', options: [tx({ de: "15 Sekunden", en: "15 seconds", es: "15 segundos" }), tx({ de: "30 Sekunden", en: "30 seconds", es: "30 segundos" }), tx({ de: "60 Sekunden", en: "60 seconds", es: "60 segundos" }), '2 Minuten', '3 Minuten', '5 Minuten'], required: true },
    { id: 'cust-11', phase: 11, question: tx({ de: "Soll ein animierter Charakter im Video erscheinen?", en: "Should an animated character appear in the video?", es: "¿Debería aparecer un personaje animado en el vídeo?" }), purpose: 'Charakter', inputType: 'select', options: [tx({ de: 'Ja, mit Charakter', en: 'Yes, with character', es: 'Sí, con carácter' }), 'Nein, nur Grafiken', 'Vielleicht'], required: true },
    { id: 'cust-12', phase: 12, question: tx({ de: "Welche Stimme soll das Voice-Over haben?", en: "Which voice should the voice-over have?", es: "¿Qué voz debe tener la locución?" }), purpose: 'Voice-Over', inputType: 'select', options: ['Männlich, professionell', 'Männlich, locker', 'Weiblich, warm', 'Weiblich, dynamisch', tx({ de: 'Kein Voice-Over', en: 'No voiceover', es: 'Sin voz en off' })], required: true },
    { id: 'cust-13', phase: 13, question: tx({ de: "In welcher Sprache soll das Video sein?", en: "What language should the video be in?", es: "¿En qué idioma debe estar el vídeo?" }), purpose: 'Sprache', inputType: 'select', options: ['Deutsch', 'Englisch', 'Spanisch', 'Mehrsprachig'], required: true },
    { id: 'cust-14', phase: 14, question: 'Welche Musikstimmung passt?', purpose: 'Musik', inputType: 'select', options: ['Energetisch', 'Inspirierend', 'Entspannt', 'Professionell', 'Emotional', tx({ de: 'Keine Musik', en: 'No music', es: 'sin musica' })], required: true },
    { id: 'cust-15', phase: 15, question: tx({ de: "Für welche Plattform ist das Video primär gedacht?", en: "Which platform is the video primarily intended for?", es: "¿A qué plataforma está destinado principalmente el vídeo?" }), purpose: 'Plattform', inputType: 'multiselect', options: ['YouTube', 'Instagram/TikTok', 'LinkedIn', 'Website', 'Präsentation', 'E-Mail/Newsletter'], required: true },
    { id: 'cust-16', phase: 16, question: 'Welche Aktion soll der Zuschauer am Ende ausführen?', purpose: 'CTA', inputType: 'text', required: true },
    { id: 'cust-17', phase: 17, question: tx({ de: 'Gibt es besondere Szenen die vorkommen müssen?', en: 'Are there any specific scenes that must be included?', es: '¿Hay alguna escena específica que deba incluirse?' }), purpose: tx({ de: "Szenen", en: "Scenes", es: "Escenas" }), inputType: 'text', required: false },
    { id: 'cust-18', phase: 18, question: tx({ de: "Hast du Referenzvideos oder Inspirationen?", en: "Do you have any reference videos or inspiration?", es: "¿Tienes algún vídeo de referencia o inspiración?" }), purpose: 'Referenzen', inputType: 'text', required: false },
    { id: 'cust-19', phase: 19, question: tx({ de: "Was sollte auf keinen Fall im Video sein?", en: "What should definitely not be in the video?", es: "¿Qué definitivamente no debería estar en el video?" }), purpose: 'Ausschlüsse', inputType: 'text', required: false },
    { id: 'cust-20', phase: 20, question: tx({ de: "Perfekt! Ich habe deine Vision verstanden. Noch etwas?", en: "Perfect! I understood your vision. Anything else?", es: "¡Perfecto! Entendí tu visión. ¿Algo más?" }), purpose: 'Finale', inputType: 'text', required: false, quickReplies: [tx({ de: "Nein, erstellen!", en: "No, create!", es: "¡No, crea!" }), 'Ja, ergänzen...'] }
  ],
  totalPhases: 20,
