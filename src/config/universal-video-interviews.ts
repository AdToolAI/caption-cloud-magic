...
export const CUSTOM_INTERVIEW: CategoryInterviewConfig = {
  ...
  phases: [
    ...
    { id: 'cust-12', phase: 12, question: tx({ de: "Welche Stimme soll das Voice-Over haben?", en: "Which voice should the voice-over have?", es: "¿Qué voz debe tener la locución?" }), purpose: 'Voice-Over', inputType: 'select', options: ['Männlich, professionell', 'Männlich, locker', 'Weiblich, warm', 'Weiblich, dynamisch', 'Kein Voice-Over'], required: true },
