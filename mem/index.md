...
- [Lipsync v72 static anchor master](mem://architecture/lipsync/v72-static-anchor-master) — Multi-Speaker (N≥2) Dialog-Mux nutzt `lock_reference_url` als Static-Image-Master statt driftendem i2v-Plate; Always-On Preclip-Overlays (1 shot/pass für volle Szene) damit alle Sprecher dauerhaft sichtbar bleiben. Lambda-Bundle muss neu deployt werden.
