...
BEGIN
  ...
  -- v385: `clip_url` ist KEINE Statusspalte. Wird sie zusammen mit
  -- `pipeline_state` geschrieben (Plate fertig, Mux fertig), muss die
  -- Legacy-Spiegelung trotzdem laufen.
  legacy_changed :=
