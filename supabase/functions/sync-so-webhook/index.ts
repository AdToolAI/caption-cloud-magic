...
serve(async (req) => {
  ...
  if (((state as any).version === 41 || (state as any).version === 42 || (state as any).version === 43 || (state as any).version === 44 || (state as any).version === 45 || (state as any).version === 46 || (state as any).version === 47 || (state as any).version === 48 || (state as any).version === 49 || (state as any).version === 50 || (state as any).version === 51 || (state as any).version === 52 || (state as any).version === 55 || (state as any).version === 56) && ((state as any).engine === "sync-official-segments" || (state as any).engine === "sync-official-segments-v50" || (state as any).engine === "sync-official-segments-v51" || (state as any).engine === "sync-official-segments-v52" || (state as any).engine === "sync-official-segments-v55" || (state as any).engine === "sync-official-segments-v56")) {
