...
async function scan(sceneFilterId: string | null) {
...

  {
    ...
    const { data: generations } = await supabase
      ...
      .select("id, user_id, artlist_job_id, started_at, total_cost_euros, model, resolution, aspect_ratio, parity_model_id, parity_provider_model_slug, parity_api_route, parity_region, parity_mode, parity_resolution_label, requested_width, requested_height")
